...
<body>
    ...
    <section class="navbar">
        <div class="container">
            ...
            <div style="display:none"class="menu text-right">
            ...
            <?php if ($tno === null): ?>
                <ul>
                    ...
                    <ul>
                    <li >
                        <a  href="<?php echo SITEURL; ?>index.php?tno=<?php echo $tno; ?>" class="active">Home</a>
                    </li>
                    ...
                    <li >
                        <a   href="<?php echo SITEURL; ?>foods.php?tno=<?php echo $tno; ?>" >Foods</a>
                    </li>
                <ul>
                    <li >
                        <a  href="<?php echo SITEURL; ?>index.php?tno=<?php echo $tno; ?>" class="active">Home</a>
